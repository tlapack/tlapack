...
void run( size_t n )
{
    ...
    std::vector<T> A_( n*n );
    auto A = tlapack::legacyMatrix<T,L>( n, n, A_.data(), n );
    ...
    auto LU = tlapack::legacyMatrix<T,L>( n, n, LU_.data(), n );
    ...
    auto X = tlapack::legacyMatrix<T,L>( n, n, X_.data(), n);
    ...
    std::vector<T> E_( n*n );
    auto E = tlapack::legacyMatrix<T,L>( n, n, E_.data(), n);
