...
void run(size_t n)
{
    ...
    if(verbose){
        ...
        tlapack::matrix_multiply(tlapack::Op::ConjTrans, tlapack::Op::NoTrans, (T)1.0, Q, A, work);
        tlapack::matrix_multiply(tlapack::Op::NoTrans, tlapack::Op::NoTrans, (T)1.0, work, Q, A);
