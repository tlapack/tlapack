...
//---------------------------------------------------------
// template<TLAPACK_SMATRIX matrix_t, TLAPACK_SMATRIX matrix_t>
// void mult_ab_upper(matrixA_t& A, matrixB_t& B) 
// {
//     using T = type_t<matrix_t>;
//     typedef tlapack::real_type<T> real_t;
//     using idx_t = tlapack::size_type<matrix_t>;
...
//     auto B00 = slice(A, range(0, n0), range(0, n0));
//     auto B01 = slice(A, range(0, n0), range(n0, n));
//     auto B11 = slice(A, range(n0, n), range(n0, n));
//
//     mult_hehe(A11, B11);
//
//     //A01^H * B01
//     gemm(Op::ConjTrans, Op::NoTrans, real_t(1), A01, B01, );
//     
// }
//--------------------------------------------------------------
template <typename T>
