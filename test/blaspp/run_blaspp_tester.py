...
group_size.add_argument(
    "--quick", action="store_true", help='run quick "sanity check" of few, small tests'
)
...
group_size.add_argument(
    "--square", action="store_true", help="run square (m = n = k) tests", default=False
)
group_size.add_argument(
    "--tall", action="store_true", help="run tall (m > n) tests", default=False
)
group_size.add_argument(
    "--wide", action="store_true", help="run wide (m < n) tests", default=False
)
group_size.add_argument(
    "--mnk",
    action="store_true",
...
group_size.add_argument(
    "--dim", action="store", help="explicitly specify size", default=""
)

group_cat = parser.add_argument_group("category (default is all)")
categories = [
    group_cat.add_argument(
        "--blas1", action="store_true", help="run Level 1 BLAS tests"
    ),
    group_cat.add_argument(
        "--blas2", action="store_true", help="run Level 2 BLAS tests"
    ),
    group_cat.add_argument(
        "--blas3", action="store_true", help="run Level 3 BLAS tests"
    ),
]
...
group_opt.add_argument(
    "--type", action="store", help="default=%(default)s", default="s,d,c,z"
)
group_opt.add_argument(
    "--layout", action="store", help="default=%(default)s", default="c,r"
)
group_opt.add_argument(
    "--transA", action="store", help="default=%(default)s", default="n,t,c"
)
group_opt.add_argument(
    "--transB", action="store", help="default=%(default)s", default="n,t,c"
)
group_opt.add_argument(
    "--trans", action="store", help="default=%(default)s", default="n,t,c"
)
group_opt.add_argument(
    "--uplo", action="store", help="default=%(default)s", default="l,u"
)
group_opt.add_argument(
    "--diag", action="store", help="default=%(default)s", default="n,u"
)
group_opt.add_argument(
    "--side", action="store", help="default=%(default)s", default="l,r"
)
group_opt.add_argument(
    "--alpha", action="store", help="default=%(default)s", default=""
)
group_opt.add_argument("--beta", action="store", help="default=%(default)s", default="")
group_opt.add_argument(
    "--incx", action="store", help="default=%(default)s", default="1,2,-1,-2"
)
group_opt.add_argument(
    "--incy", action="store", help="default=%(default)s", default="1,2,-1,-2"
)
group_opt.add_argument(
    "--align", action="store", help="default=%(default)s", default="32"
)
group_opt.add_argument(
    "--check", action="store", help="default=y", default=""
)  # default in test.cc
group_opt.add_argument(
    "--ref", action="store", help="default=y", default=""
)  # default in test.cc
...
if not opts.dim:
    ...
    if opts.medium:
        ...
        mnk += (
            " --dim 100x300x600 --dim 300x100x600"
    ...
    if opts.large:
        ...
        mnk += (
            " --dim 1000x3000x6000 --dim 3000x1000x6000"
...
if opts.blas2:
    cmds += [
        ...
        ["symv", dtype_real + layout + align + uplo + n + incx + incy],
        ["syr", dtype_real + layout + align + uplo + n + incx],
