...
/// @brief Test GEQR2, GEQRF and UNG2R
//
                   ...
                   TLAPACK_TYPES_TO_TEST)
{
    ...
    workOpts.nb = nb;
    workinfo_t workinfo;
    geqrf_worksize(A, tauw, workinfo, workOpts);
    ung2r_worksize(k, Q, tauw, workinfo, workOpts);
