...
inline constexpr void ungrq_worksize(const matrix_t& A,
                                     const vector_t& tau,
                                     workinfo_t& workinfo,
                                     const ungrq_opts_t<workT_t>& opts = {})
{
    ...
    // larfb:
    {
        ...
        larfb_worksize(right_side, conjTranspose, backward, rowwise_storage, V,
          ...
          const ungrq_opts_t<workT_t>& opts = {})
{
    ...
    Workspace work = [&]() {
        workinfo_t workinfo;
        ungrq_worksize(A, tau, workinfo, opts);
