...
template <TLAPACK_MATRIX matrix_t,
          ...
          class workT_t = void>
inline constexpr void ungql_worksize(const matrix_t& A,
                                     const vector_t& tau,
                                     workinfo_t& workinfo,
                                     const ungql_opts_t<workT_t>& opts = {})
{
    ...
    // larfb:
    {
        ...
        larfb_worksize(left_side, noTranspose, backward, columnwise_storage, V,
          ...
          const ungql_opts_t<workT_t>& opts = {})
{
    ...
    Workspace work = [&]() {
        workinfo_t workinfo;
        ungql_worksize(A, tau, workinfo, opts);
