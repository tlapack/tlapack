    ...
    int trtri_recursive(const Uplo &uplo, matrix_t &C, const ErrorCheck &ec = {})
    {
        ...
        else
        {
            ...
            if (uplo == Uplo::Lower)
            {
                ...
                int info = trtri_recursive(Uplo::Lower, C00, ec);
                if (info != 0)
                {
                ...
                info = trtri_recursive(Uplo::Lower, C11, ec);
                if (info == 0)
                    return 0;
                else
                {
            ...
            else
            {
                ...
                int info = trtri_recursive(Uplo::Upper, C00, ec);
                if (info != 0)
                {
                    tlapack_error_internal(ec, info,
                                           "A diagonal of entry of triangular matrix is exactly zero.");
                ...
                info = trtri_recursive(Uplo::Upper, C11, ec);
                if (info == 0)
                    return 0;
                else
                {
