        ...
        //
        {
            ...
            if (ilo + n_shifts + 1 < istop_m)
            {
                ...
                while (i < istop_m)
                {
                    ...
                    matrix_multiply(Op::ConjTrans, Op::NoTrans, one, U2, A_slice, WH_slice);
            ...
            if (istart_m < ilo)
            {
                ...
                while (i < ilo)
                {
                    ...
                    matrix_multiply(Op::NoTrans, Op::NoTrans, one, A_slice, U2, WV_slice);
            ...
            if (want_z)
            {
                ...
                while (i < n)
                {
                    ...
                    matrix_multiply(Op::NoTrans, Op::NoTrans, one, Z_slice, U2, WV_slice);
